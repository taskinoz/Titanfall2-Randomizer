...
{
	Remote_CallFunction_NonReplay( player, "ServerCallback_AddCredits", eCredits.RANDOMIZER )
...
void function Credits_Init_Client()
{
	...
	file.registeredFuncs[ eCredits.RANDOMIZER ] 	<- Add_Randomizer
...
void function Add_Randomizer()
{
	...
	Add_Title( "Randomizer Mod" )
	Add_Name( "Taskinoz / Tristan" )
	wait STANDARD_DELAY

	Add_Title( "Mod Developers" )
	Add_Name( "Taskinoz / Tristan" )
	Add_Name( "JustANormalUser / EladNLG" )
	wait STANDARD_DELAY
